...
public static int[][] ticbox;
	public static int win(int [][]tic) {
		...
		if((ticbox[0][0]==1&& ticbox[0][1]==1&&ticbox[0][2]==1)||(ticbox[1][0]==1&& ticbox[1][1]==1&&ticbox[1][2]==1)||(ticbox[2][0]==1&& ticbox[2][1]==1&&ticbox[2][2]==1)) {
			return 1;
		}
		if((ticbox[0][0]==2&& ticbox[0][1]==2&&ticbox[0][2]==2)||(ticbox[1][0]==2&& ticbox[1][1]==2&&ticbox[1][2]==2)||(ticbox[2][0]==2&& ticbox[2][1]==2&&ticbox[2][2]==2)){
			return 2;
		}
